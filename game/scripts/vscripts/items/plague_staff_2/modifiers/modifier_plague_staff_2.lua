modifier_plague_staff_2 = class({})
--------------------------------------------------------------------------------

function modifier_plague_staff_2:IsHidden()
	return true
end

--------------------------------------------------------------------------------

function modifier_plague_staff_2:IsPurgable()
	return false
end

--------------------------------------------------------------------------------

function modifier_plague_staff_2:DestroyOnExpire()
	return false
end

--------------------------------------------------------------------------------

function modifier_plague_staff_2:GetAttributes() 
	return MODIFIER_ATTRIBUTE_MULTIPLE + MODIFIER_ATTRIBUTE_PERMANENT
end

--------------------------------------------------------------------------------

function modifier_plague_staff_2:OnCreated( kv )

end

--------------------------------------------------------------------------------

function modifier_plague_staff_2:DeclareFunctions()
	local funcs = {
...
function modifier_plague_staff_2:GetModifierConstantHealthRegen( params )
	return self:GetAbility():GetSpecialValueFor("bonus_hpregen") or 0
end

--------------------------------------------------------------------------------

function modifier_plague_staff_2:GetModifierBonusStats_Strength( params )
	return self:GetAbility():GetSpecialValueFor("bonus_str") or 0
end

--------------------------------------------------------------------------------

function modifier_plague_staff_2:GetModifierBonusStats_Agility( params )
	return self:GetAbility():GetSpecialValueFor("bonus_agi") or 0
end

--------------------------------------------------------------------------------

function modifier_plague_staff_2:GetModifierBonusStats_Intellect( params )
	return self:GetAbility():GetSpecialValueFor("bonus_int") or 0
end

--------------------------------------------------------------------------------

function modifier_plague_staff_2:GetModifierSpellAmplify_Percentage( params )
	return self:GetAbility():GetSpecialValueFor("bonus_spellamp") or 0
end

--------------------------------------------------------------------------------

function modifier_plague_staff_2:GetModifierPhysicalArmorBonus( params )
	return self:GetAbility():GetSpecialValueFor("bonus_armor") or 0
end

--------------------------------------------------------------------------------

function modifier_plague_staff_2:GetModifierManaBonus( params )
...
function modifier_plague_staff_2:OnTakeDamage( params )
	  if IsServer() then
