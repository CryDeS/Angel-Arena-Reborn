modifier_forgotten_hero_spirit_releash_debuff = modifier_forgotten_hero_spirit_releash_debuff or class({})
local mod = modifier_forgotten_hero_spirit_releash_debuff
