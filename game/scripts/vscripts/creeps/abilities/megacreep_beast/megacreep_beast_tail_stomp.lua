megacreep_beast_tail_stomp = class({})

---------------------------------------------------------------------------

function megacreep_beast_tail_stomp:CreateEffects(caster, position)
...
function megacreep_beast_tail_stomp:OnAbilityPhaseStart()
	self:GetCaster():EmitSound("CNY_Beast.Ability.Cast")
	return true 
end 

function megacreep_beast_tail_stomp:OnSpellStart()
