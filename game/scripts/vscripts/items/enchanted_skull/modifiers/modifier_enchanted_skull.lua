modifier_enchanted_skull = modifier_enchanted_skull or class({})
local mod = modifier_enchanted_skull
...
function mod:OnAttackLanded(params)
	...
	target:AddNewModifier(parent, ability, "modifier_enchanted_skull_debuff", { duration = self.disarmorDuration })
end
